...
int exec_remote_cmd_loop(char *address, int port)
{
    ...
    int cli_socket;
    ssize_t io_size;
    int is_eof, recv_bytes = 0;

    // TODO:DONE set up cmd and response buffs
    ...
    while (1) 
    {
        // TODO:DONE print prompt
        printf("%s", SH_PROMPT);

        // TODO:DONE fgets input
